...
[![Wygląd pierwszej strony GitHub](pictures/github_web.png){width="1000"}](https://github.com)
...
```{r}
# ta komenda pozwala strawdzić wersję R
R.version.string
```

![Do sprawdzenia wersji Rstudio należy w programie kliknąć kolejno *Help\>\>About Rstudio*](pictures/rstudio.png)
